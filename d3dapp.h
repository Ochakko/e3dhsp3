...
public:
	...
	int CheckFullScreenParams( int flag, DWORD w, DWORD h, int bits, int* flagptr, int* wptr, int* hptr, int* bitsptr );
...
//    LPDIRECT3DDEVICE9 m_pd3dDevice;      public‚Ö  // The D3D rendering device
...
public:
    ...
    virtual HRESULT RestoreDeviceObjects( int resetflag = 0 );//                     { return S_OK; }
